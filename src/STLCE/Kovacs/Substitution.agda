...
sub σ (ι₁ M)        = ι₁ (sub σ M)
sub σ (ι₂ M)        = ι₂ (sub σ M)
sub σ (M ⁇ N₁ ∥ N₂) = sub σ M ⁇ sub (liftₛ σ) N₁
                              ∥ sub (liftₛ σ) N₂
...
mutual
  ...
  sub◑ σ η (π₂ M)        = π₂ & sub◑ σ η M
  sub◑ σ η τ             = refl
  sub◑ σ η (φ M)         = φ & sub◑ σ η M
  sub◑ σ η (ι₁ M)        = ι₁ & sub◑ σ η M
  sub◑ σ η (ι₂ M)        = ι₂ & sub◑ σ η M
  sub◑ σ η (M ⁇ N₁ ∥ N₂) = _⁇_∥_ & sub◑ σ η M
                                 ⊗ sublift◑ σ η N₁
                                 ⊗ sublift◑ σ η N₂
...
mutual
  ...
  sub◐ η σ (π₂ M)        = π₂ & sub◐ η σ M
  sub◐ η σ τ             = refl
  sub◐ η σ (φ M)         = φ & sub◐ η σ M
  sub◐ η σ (ι₁ M)        = ι₁ & sub◐ η σ M
  sub◐ η σ (ι₂ M)        = ι₂ & sub◐ η σ M
  sub◐ η σ (M ⁇ N₁ ∥ N₂) = _⁇_∥_ & sub◐ η σ M
                                 ⊗ sublift◐ η σ N₁
                                 ⊗ sublift◐ η σ N₂
...
mutual
  ...
  sub● σ₁ σ₂ (π₂ M)        = π₂ & sub● σ₁ σ₂ M
  sub● σ₁ σ₂ τ             = refl
  sub● σ₁ σ₂ (φ M)         = φ & sub● σ₁ σ₂ M
  sub● σ₁ σ₂ (ι₁ M)        = ι₁ & sub● σ₁ σ₂ M
  sub● σ₁ σ₂ (ι₂ M)        = ι₂ & sub● σ₁ σ₂ M
  sub● σ₁ σ₂ (M ⁇ N₁ ∥ N₂) = _⁇_∥_ & sub● σ₁ σ₂ M
                                   ⊗ sublift● σ₁ σ₂ N₁
                                   ⊗ sublift● σ₁ σ₂ N₂
